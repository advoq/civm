...
- **Alvo legado inválido:** `MinFreeGB=58` é maior que o filesystem inteiro e
  não pode ser atingido. A recalibração depende primeiro da limpeza scoped de
  `advoq/civm#181` e das medições de `advoq/civm#182`.
...
> `emersonbusson/civm-host#17`, `advoq/civm#181` e `advoq/civm#182`.
